...
$result = mysqli_query($link, "select * from tabel_buku where judul = '$cari'");
        ...
        <div class='container'>
                    ...
                    <div class='card' style='width: 100%;'>
                        <ul class='list-group list-group-flush'>
                            ...
                            <li class='list-group-item'><h6>Jenis Buku :</h6> $baris[2]</li>
                            <li class='list-group-item'><h6>Nama penulis :</h6> $baris[3]</li>
